...
public class WorkWithAdapter extends ArrayAdapter<GSSWorkWith> {
private Activity mActivity;
private List<GSSWorkWith> list = new ArrayList<>();
public WorkWithAdapter(@NonNull Activity activity, int resource, int textViewResourceId, List<GSSWorkWith> list) {
...
@Nullable
@Override
public GSSWorkWith getItem(int position) {
...
public View getDropDownView(int position, View convertView, ViewGroup parent) {
        ...
        lbl.setText(list.get(position).getWorkWith());
        return v;
        }
