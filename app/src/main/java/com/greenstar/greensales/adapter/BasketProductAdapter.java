...
public class BasketProductAdapter extends ArrayAdapter<ProductDetail> {
    private Activity mActivity;
    private List<ProductDetail> list = new ArrayList<>();
    public BasketProductAdapter(@NonNull Activity activity, int resource, int textViewResourceId, List<ProductDetail> list) {
    ...
    public View getDropDownView(int position, View convertView, ViewGroup parent) {
        ...
        lbl.setText("Product Name : "+ list.get(position).getName()+"\n"+"Quantity : "+list.get(position).getQuantity());
        return v;
    }
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        lbl.setText("Product "+number+": "+ list.get(position).getName()+" | "+list.get(position).getQuantity());
        return v;
    }
}
